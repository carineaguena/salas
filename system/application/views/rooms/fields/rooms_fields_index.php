...
<?php
$icondata[0] = array('rooms/fields/add', 'Adicionar Campo', 'add.gif' );
$icondata[1] = array('rooms', 'Salas', 'school_manage_rooms.gif' );
...
<table width="100%" cellpadding="2" cellspacing="2" border="0" class="sort-table" id="jsst-roomfields">
	...
	<tr class="heading">
		...
		<td class="h" title="Options">Opções</td>
	...
	<?php $i++; }
		...
		echo '<td colspan="4" align="center" style="padding:16px 0">Não existe campos adicionais para salas!</td>';
	}
	?>
	</tbody>
</table>
