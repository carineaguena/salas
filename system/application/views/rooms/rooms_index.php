...
<?php
$icondata[0] = array('rooms/add', 'Adiciona Sala', 'add.gif' );
$icondata[1] = array('rooms/fields', 'Define Campos', 'room_fields.gif' );
...
<table width="100%" cellpadding="2" cellspacing="2" border="0" class="sort-table" id="jsst-rooms">
	...
	<tr class="heading">
		...
		<td class="h" title="Teacher">Professor</td>
		<!-- <td class="h" title="Notes">Notes</td> -->
		<td class="h" title="Photo">Foto</td>
