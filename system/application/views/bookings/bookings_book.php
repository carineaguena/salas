...
<fieldset><legend accesskey="I" tabindex="<?php echo $t; $t++; ?>">Informação de Agendamento</legend>
...
<?php if($this->userauth->CheckAuthLevel(ADMINISTRATOR, $this->authlevel)){ ?>
<fieldset><legend accesskey="R" tabindex="<?php echo $t; $t++; ?>">Opções de Repetição</legend>
...
<?php
$submit['submit'] = array('Agendar', $t);
$submit['cancel'] = array('Cancelar', $t+1, $this->session->userdata('uri'));
