...
<?php
$icondata[0] = array('weeks/add', 'Adicionar Semana', 'add.gif');
//$icondata[1] = array('weeks/dates', 'Week dates', 'school_manage_weeks.gif');
$icondata[1] = array('weeks/academicyear', 'Ano acadêmico', 'school_manage_weeks_academicyear.gif');
...
<table width="100%" cellpadding="2" cellspacing="2" border="0" class="sort-table" id="jsst-weeks">
	...
	<?php $i++; }
		...
		echo '<td colspan="4" align="center" style="padding:16px 0">Nenhuma semana definida!</td>';
	}
	?>
	</tbody>
</table>
