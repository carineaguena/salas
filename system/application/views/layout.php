...
if($this->loggedin){
	$menu[1]['text'] = '<img src="webroot/images/ui/link_controlpanel.gif" hspace="4" align="top" alt=" " />Painel de Controle';
	$menu[1]['href'] = site_url('controlpanel');
	$menu[1]['title'] = 'Tarefas';
	...
	$menu[3]['text'] = '<img src="webroot/images/ui/logout.gif" hspace="4" align="top" alt=" " />Sair';
	$menu[3]['href'] = site_url('logout');
	$menu[3]['title'] = 'Feche sua sessão atual';
}
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<title>Sistema de Agendamentos de Salas | <?php echo strtolower($title) ?></title>
	...
	<div class="outer">
		...
		<div class="header">
			...
			<div class="nav-box">
				...
				<p class="normal">Logado como <?php echo (strlen($this->session->userdata('displayname')) > 1) ? $this->session->userdata('displayname') : $this->session->userdata('username'); ?></p>
				<?php } ?>
			</div>
			...
			<span class="title">
				...
				if($this->session->userdata('schoolname')){
					...
					echo '<a href="'.$this->config->item('base_url').'" title="Classroom Bookings" style="font-weight:normal;color:#0081C2;letter-spacing:-2px">Agenda<span style="color:#ff6400;font-weight:bold"> de Salas</span></a>';
					echo '<sup style="font-weight:bold;color:#555;letter-spacing:-1px;font-size:12pt">IFC-Camboriú</sup>';
				}
				?>
			</span>
